...
#pragma region Member versions of functions
	...
	template<typename T, PackingMode P>
	T Vector<T, 4, P>::Length() { return PWMath::Length(*this); }

	template<typename T, PackingMode P>
	T Vector<T, 4, P>::Length2() { return PWMath::Length2(*this); }

	template<typename T, PackingMode P>
	Vector<T, 4, P> Vector<T, 4, P>::Normalize() { return PWMath::Normalize(*this); }

	template<typename T, PackingMode P>
	T Vector<T, 4, P>::Dot(const Vector<T, 4, P>& rhs) { return PWMath::Dot(*this, rhs); }
